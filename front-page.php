<?php get_header(); ?>
    ...
    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
        ...
        <div <?php post_class('hero__wrapper') ?> id="post-<?php the_ID(); ?>">
            ...
            <p class="front-page_-text">In poll after poll, most clients in #FamilyLaw matters want the opportunity to be heard, which is coincidentally part of the Due Process guarantee of the Constitution. I strive for you to understand your options, potential outcomes to the best of my knowledge and instill the ability to understand your rights and entitlements are should you choose to waive them or pursue them. I work to #PowerUp my clients and love evening playing fields. I am not licensed in Indiana. I am a GAL and mediator. In this job, strategy is everything, and experience counts. I would be happy to guide you through your #FamilyLaw case, whether as your lawyer or your mediator. Let's GO!</p>
